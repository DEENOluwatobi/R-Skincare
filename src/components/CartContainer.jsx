  ...
  return (
    ...
    className='fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]'>
        <div className='w-full flex items-center justify-between p-4'>
            ...
            <motion.p whileTap={{scale:0.75}} onClick={clearCart} className='flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 
                ...
                <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
                    ...
                    <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2'>
                        <div className='w-full flex items-center justify-between'>
                            ...
                            <p className='text-gray-400 text-lg'><span>$</span>{tot}</p>
                        </div>
                        <div className='w-full flex items-center justify-between'>
                        ...
                        <div className='w-full flex items-center justify-between'>
                            ...
                            <p className='text-gray-200 text-xl font-semibold'><span>$</span>{tot + 1.50}</p>
                        </div>
